...
I believe tools should amplify human creativity, never replace it. Nothing I ship is created solely by a machine. I think art made by humans carries intention, and you can feel the difference.

I use AI as a tool, but everything I ship is my responsibility: the good and the broken. If AI contributed to a bug, a bad line of dialog, or anything else that slips through, that's on me.
...
## Art
No AI-made characters, environments, concept art, promo assets, or visuals of any kind. 

## Sound effects
I have a collection of sound effects I've purchased over the years from other humans that I use as-is, or further refine in audio editing tools.
